...
class AgentBridge(QObject):
    ...
    def init_backend(self) -> bool:
        ...
        try:
            ...
            # 从 workbench.core 导入后端模块
            from .core.services.database import init_db, get_db_path
            ...
            self.log_signal.emit("info", f"数据库: {self._db_path}")
            self.log_signal.emit("info", f"模型: {self._llm_client.model}")
            return True
